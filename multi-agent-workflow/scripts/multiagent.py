...
AGENT_TYPE_NOTES = {
    "generic": "This prompt is the complete task contract. Do not assume any hidden chat context.",
    ...
    "qwen": "Qwen note: treat this prompt as the full contract and avoid broad rewrites outside the allowed paths.",
