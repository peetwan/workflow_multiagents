...
free Python runtime that can coordinate Codex, Claude, Gemini, Antigravity, Qwen,
openweight/open-source coding models, and any other agent that can work from a
Git worktree.
...
python multi-agent-workflow/scripts/multiagent.py --repo C:\path\to\repo install
```

After install, use the repo-local copy:
